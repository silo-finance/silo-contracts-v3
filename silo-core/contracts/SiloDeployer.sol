...
//         _createIncentivesController(siloConfig);

//         emit SiloCreated(siloConfig);
//     }

//     function _createIncentivesController(
//         ISiloConfig _siloConfig,
//         ISiloConfig.InitData memory _siloInitData
//     ) internal returns (address incentivesController) {
//         address hook = _siloConfig.hookReceiver();
//         if (!_isDefaultingHook(hook)) return;

//         address debtSilo = _getDebtSilo(_siloConfig, _siloInitData);

//         incentivesController = SILO_INCENTIVES_CONTROLLER_FACTORY.create({
//             _owner: msg.sender,
//             _notifier: hook,
...
//         IGaugeHookReceiver(incentivesController).setGauge(incentivesController, IShareToken(debtSilo));
//     }
...
//     function _getDebtSilo(
//         ISiloConfig _siloConfig,
//         ISiloConfig.InitData memory _siloInitData
//     ) internal view returns (address debtSilo) {
