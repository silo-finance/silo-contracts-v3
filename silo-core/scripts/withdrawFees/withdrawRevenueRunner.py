...
TASKS: list[tuple[str, str]] = [
    ...
    # ("0x8C1b49B1A45d9FD50c5846a6Cd19a5ADaA376B1B", "RPC_ARBITRUM"), // old factory
    # ("0xb562b6CdEEE3ec10E4803B8dcfef81a32074e6B5", "RPC_ARBITRUM"), // old factory
    # ("0x408822E4E8682413666809b0655161093cd36f2b", "RPC_ARBITRUM"), // old factory
