...
contract KinkCryticToFoundry is DynamicKinkModelHandlers, Invariants, Test {
    ...
    */
    function test_assert_when_u_decrease_rcur_decrease_afterAction() public {
        DynamicKinkModelTester.updateConfig(
            -17706884433,
            131337938655927245046287770291788504640879745018714415283497790964154,
            0,
            1271435406135215068,
            15068867717508853911873259130714771631726232874615716943776576334513877,
            439,
            45294580151249760655,
            749,
            -32590934936,
            1,
            0,
    ...
    */
    function test_kink_rcomp_monotonicity() public {
        DynamicKinkModelTester.deposit(49919543028822338007760319633893779722);
        DynamicKinkModelTester.updateConfig(86751946891207756944127219323,0,4492163862583792399905903230753356658158984587077176505129684365401201233,171354448017320066665972098165283300904227664381038114145866169763948137,-26966076380526541412715716690588,1158124231538980336,27008638365196117588093633,2402396482028476868515500338982061144804504818477140088951436544550131073,352648897748194078908699065580390805549240884251437532774920008401563901,516687131442706182200239504698285756405027898872717979370628603109946259,-414387872301514832475382593,561968041451349492913461174128667);
        DynamicKinkModelTester.borrow(50073689115897192406);
        DynamicKinkModelTester.assert_rcomp_monotonicity(10,18,49405027756188010985463281693852990450);
    }
}
