...
contract XDataTester is XDataReader {
    ...
    string constant NEW_MARKETS_FILE = "new_stream_markets_positions.json";
    string constant NEW_VAULTS_FILE = "new_stream_vaults_positions.json";
    ...
    */
    ...
    /* 
    FOUNDRY_PROFILE=core_test forge test --mt test_skip_xData_new_markets --ffi -vvv
    */
    function test_skip_xData_new_markets() public {
        _check_xData_markets(NEW_MARKETS_FILE);
    }

    /* 
    FOUNDRY_PROFILE=core_test forge test --mt test_skip_xData_new_vaults --ffi -vv
    */
    function test_skip_xData_new_vaults() public {
        _check_xData_markets(NEW_VAULTS_FILE);
    }
