...
/*
    FOUNDRY_PROFILE=core_test forge test -vv --ffi --mc ManualLiquidationHelperSTokensTest
*/
contract ManualLiquidationHelperSTokensTest is ManualLiquidationHelperCommon {
